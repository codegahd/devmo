import PoolChanceMarket from "./PoolChanceMarket"
import PoolDoubleChanceMarket from "./PoolDoubleChanceMarket"
import PoolGoalMarket from "./PoolGoalMarket"


const Poolbet = ({games,odds,leagues,dispatch,setSelection}) => {
        ...
        leagues.map((league,index)=>{
            ...
            return(
                <div className="mb-2 text-lg" key={index}>
                    <div className="flex bg-green-600 text-lg font-semibold px-3 py-4 justify-between mx-2 ">
